...
const Header = () => {
    ...
    const displayUser = userData ?? { name: 'Rovor Admin', role: 'Admin', email: 'support@rovor.com' };
    ...
    const [notifications, setNotifications] = useState([
        ...
        },
        {
            ...
            message: '<strong class="text-sm mr-1">Adam Nolan</strong> mentioned you in <strong>UX Basics</strong>',
            time: '9h Ago',
        },
        {
            id: 3,
            profile: 'profile-16.jpeg',
            message: '<strong class="text-sm mr-1">Anna Morgan</strong> uploaded a file',
            time: '9h Ago',
        },
    ]);
                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="inline w-8 ltr:-ml-1 rtl:-mr-1" src="/rovor-logo.svg" alt="logo" />
                    ...
                    <div className="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                            ...
                            >
                                <ul className="w-[300px] !py-0 text-xs text-dark dark:text-white-dark sm:w-[375px]">
                                    <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                                        <div className="relative !h-[68px] w-full overflow-hidden rounded-t-md p-5 text-white">
                                            <div className="absolute inset-0 h-full w-full bg-[url(/assets/images/menu-heade.jpg)] bg-cover bg-center bg-no-repeat"></div>
                                    ...
                                    {messages.length > 0 ? (
                                            ...
                                            <li onClick={(e) => e.stopPropagation()}>
                                                {messages.map((message) => (
                                                    <div key={message.id} className="flex items-center px-5 py-3">
                                                        <div dangerouslySetInnerHTML={createMarkup(message.image)} />
                                        ...
                                        <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                                            <button type="button" className="!grid min-h-[200px] place-content-center text-lg">
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="relative block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                                button={
                                    <span>
                                        <IconBellBing />
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="truncate ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    {displayUser.name}
                                                    <span className="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">{displayUser.role}</span>
                                                </h4>
                    ...
                    <li className="menu nav-item relative">
                        <Link href="/tickets" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Tickets</span>
                            </div>
                        </Link>
                    </li>
                </ul>
