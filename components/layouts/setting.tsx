...
const Setting = () => {
    ...
    return (
        <div>
            ...
            <nav
                className={`${(showCustomizer && 'ltr:!right-0 rtl:!left-0') || ''} fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-black`}
            >
                <button
                    type="button"
                ...
                <div className="perfect-scrollbar h-full overflow-y-auto overflow-x-hidden">
                    <div className="relative pb-5 text-center">
                        ...
                        <p className="text-white-dark">Set preferences that will be stored locally for your preview.</p>
                    </div>
